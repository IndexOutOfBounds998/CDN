    ...
    return function i(s, a, l) {
        ...
        5: [function(e, t, n) {
            ...
            r.prototype.dispatchEvent = function() {
                ...
                if (this["on" + t] && this["on" + t].apply(this, n),
        ...
        10: [function(e, t, n) {
            ...
            function a(e) {
                ...
                this.ir.once("finish", function(e, t) {
                    n.ir = null,
                    n.emit("message", JSON.stringify([e, t]))
                })
            }
            r(a, o),
                ...
                (function() {
                    ...
                    y.prototype._connect = function() {
                        for (var e = this._transports.shift(); e; e = this._transports.shift()) {
                            if (b("attempt", e.transportName),
                            e.needBody && (!w.document.body || void 0 !== w.document.readyState && "complete" !== w.document.readyState && "interactive" !== w.document.readyState))
                                return b("waiting for body"),
                    ...
                    y.prototype._transportMessage = function(e) {
                        ...
                        case "h":
                            return this.dispatchEvent(new s("heartbeat")),
                    ...
                    y.prototype._open = function() {
                        ...
                        b("connected", this.transport)) : this._close(1006, "Server lost session")
                    }
                    ,
        ...
        15: [function(e, t, n) {
            ...
            d(c, {
                forEach: function(e, t) {
                    ...
                    if (!a(e))
                        throw new TypeError;
                    for (; ++i < s; )
                        i in r && e.call(o, r[i], i, n)
                }
            }, (v = c.forEach,
            y = b = !0,
            v && (v.call("foo", function(e, t, n) {
                "object" != typeof n && (b = !1)
            }),
            v.call([1], function() {
            ...
            d(c, {
                indexOf: function(e, t) {
                    ...
                    for (1 < arguments.length && (o = function(e) {
                        var t = +e;
                        return t != t ? t = 0 : 0 !== t && t !== 1 / 0 && t !== -1 / 0 && (t = (0 < t || -1) * Math.floor(Math.abs(t))),
                        t
                    }(t)),
            ...
            s.split = function(e, t) {
                ...
                t = void 0 === t ? -1 >>> 0 : function(e) {
                    return e >>> 0
                }(t); (o = e.exec(n)) && !(u < (i = o.index + o[0].length) && (a.push(n.slice(u, o.index)),
        ...
        17: [function(o, f, e) {
            (function(r) {
                (function() {
                    ...
                    !c.enabled && t in r && (u("overriding xmlhttprequest"),
        ...
        22: [function(e, t, n) {
            ...
            f.prototype._message = function(t) {
                if (c("message", t.data),
                s.isOriginEqual(t.origin, this.origin)) {
                    var n;
                    try {
                        n = JSON.parse(t.data)
                    } catch (e) {
                    ...
                    if (n.windowId === this.windowId)
                        ...
                        case "c":
                            ...
                            this.emit("close", e[0], e[1]),
                            this.close()
                        }
                    else
                        c("mismatched window id", n.windowId, this.windowId)
                } else
                    c("not same origin", t.origin, this.origin)
            }
            ,
        ...
        27: [function(e, t, n) {
            ...
            s.prototype._scheduleReceiver = function() {
                ...
                r.once("close", function(e, t) {
                    ...
                    n.poll = r = null,
                    n.pollIsClosing || ("network" === t ? n._scheduleReceiver() : (n.emit("close", e || 1006, t),
        ...
        29: [function(e, t, n) {
            ...
            function a(e) {
                ...
                r.onmessage = function(e) {
                    s("message", e.data),
                    n.emit("message", decodeURI(e.data))
                }
                ,
                ...
                (function() {
                    ...
                    u.prototype._createScript = function(e) {
                        ...
                        r.onreadystatechange = function() {
                            if (l("onreadystatechange", r.readyState),
                        ...
                        void 0 === r.async && c.document.attachEvent)
                            if (s.isOpera())
                                (t = this.script2 = c.document.createElement("script")).text = "try{var a = document.getElementById('" + r.id + "'); if(a)a.onerror();}catch(x){};",
                                r.async = t.async = !1;
                            else {
                                try {
                                    r.htmlFor = r.id,
        ...
        38: [function(e, t, n) {
            ...
            function c(e, t, n) {
                ...
                this.ws.onmessage = function(e) {
                    u("message event", e.data),
                    r.emit("message", e.data)
                }
                ,
                this.unloadRef = i.unloadAdd(function() {
                    u("unload"),
            ...
            (function(n) {
                (function() {
                    ...
                    n.crypto && n.crypto.getRandomValues ? t.exports.randomBytes = function(e) {
                        ...
                        return n.crypto.getRandomValues(t),
                        t
                    }
        ...
        47: [function(t, p, e) {
            (function(d) {
                (function() {
                    ...
                    d.document && (p.exports.iframeEnabled = ("function" == typeof d.postMessage || "object" == typeof d.postMessage) && !e.isKonqueror())
                }
                ).call(this)
            }
            ).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
                ...
                return {
                    filterToEnabled: function(t, n) {
                        ...
                        e.forEach(function(e) {
                            ...
                            r.main.push(e),
                            e.facadeTransport && r.facade.push(e.facadeTransport)) : o("disabled", e.transportName) : o("disabled from server", "websocket"))
                        }),
                        r
                    }
                }
            ...
            t.exports = {
                getOrigin: function(e) {
                    ...
                    if ("file:" === t.protocol)
                        return null;
                    var n = t.port;
                    return n = n || ("https:" === t.protocol ? "443" : "80"),
            ...
            (function(a) {
                (function() {
                    ...
                    function x(e, t) {
                        ...
                        a = r[3].length) : n = r[4],
                        "file:" === o ? 2 <= a && (n = n.slice(2)) : w(o) ? n = r[4] : o ? i && (n = n.slice(2)) : 2 <= a && w(t.protocol) && (n = r[4]),
                        {
                            protocol: o,
                            slashes: i || w(o),
                            slashesCount: a,
                    ...
                    function _(e, t, n) {
                        ...
                        e = o.rest,
                        ("file:" === o.protocol && (2 !== o.slashesCount || v.test(e)) || !o.slashes && (o.protocol || o.slashesCount < 2 || !w(f.protocol))) && (u[3] = [/(.*)/, "pathname"]); h < u.length; h++)
                            "function" != typeof (s = u[h]) ? (i = s[0],
                            l = s[1],
                            i != i ? f[l] = e : "string" == typeof i ? ~(a = "@" === i ? e.lastIndexOf(i) : e.indexOf(i)) && (e = "number" == typeof s[2] ? (f[l] = e.slice(0, a),
                            e.slice(a + s[2])) : (f[l] = e.slice(a),
                            e.slice(0, a))) : (a = i.exec(e)) && (f[l] = a[1],
                            e = e.slice(0, a.index)),
                            f[l] = f[l] || r && s[3] && t[l] || "",
                        ...
                        f.auth && (~(a = f.auth.indexOf(":")) ? (f.username = f.auth.slice(0, a),
                        f.username = encodeURIComponent(decodeURIComponent(f.username)),
                        f.password = f.auth.slice(a + 1),
                        f.password = encodeURIComponent(decodeURIComponent(f.password))) : f.username = encodeURIComponent(decodeURIComponent(f.auth)),
                    ...
                    _.prototype = {
                        set: function(e, t, n) {
                            ...
                            case "port":
                                r[e] = t,
                                d(t, r.protocol) ? t && (r.host = r.hostname + ":" + t) : (r.host = r.hostname,
                                r[e] = "");
                                break;
                            case "hostname":
                                r[e] = t,
                        ...
                        toString: function(e) {
                            ...
                            i += "@") : "file:" !== n.protocol && w(n.protocol) && !r && "/" !== n.pathname && (i += "@"),
