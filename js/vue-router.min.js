...
e = function() {
    ...
    function h(t, e, r, n) {
        ...
        return r && (a.redirectedFrom = y(r, o)),
        Object.freeze(a)
    }
    function l(t) {
        if (Array.isArray(t))
    ...
    var B, H = [String, Object], z = [String, Array], D = function() {}, F = {
        name: "RouterLink",
        props: {
            to: {
                type: H,
        ...
        render: function(t) {
            ...
            s[g] = m(o, b),
            s[y] = this.exact ? s[g] : function(t, e) {
    ...
    function X(t, e) {
        ...
        function a(t, r, a) {
            ...
            if (s) {
                ...
                return c.path = M(p.path, c.params),
                u(p, c, a)
            }
            if (c.path) {
                c.params = {};
        ...
        function c(t, r) {
            ...
            var c = o
              ...
              , l = r.hash
              , d = r.params;
            return f = c.hasOwnProperty("query") ? c.query : f,
    ...
    var ft, ht = K && (-1 === (ft = window.navigator.userAgent).indexOf("Android 2.") && -1 === ft.indexOf("Android 4.0") || -1 === ft.indexOf("Mobile Safari") || -1 !== ft.indexOf("Chrome") || -1 !== ft.indexOf("Windows Phone")) && window.history && "pushState"in window.history;
    function lt(t, e) {
        it();
        ...
        var l = function(e, n) {
            ...
            try {
                e(r, a, function(e) {
                    ...
                    c(e)) : "string" == typeof e || "object" == typeof e && ("string" == typeof e.path || "string" == typeof e.name) ? (c(),
